          ...
          {pricingPlans.map((plan, index) => (
            ...
            >
              ...
              <div className="p-8">
                ...
                <Link 
                  href="/booking" 
                  className={`w-full inline-block text-center py-3 px-6 rounded-xl transition-all font-medium ${
                    plan.featured
                      ? 'btn-marc btn-marc-accent hover:shadow-lg'
                      : 'btn-marc btn-marc-outline'
                  }`}
                >
