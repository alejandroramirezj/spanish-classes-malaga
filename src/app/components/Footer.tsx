        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <p className="text-gray-300 mb-6">
              Clases de español personalizadas en Málaga con Virginia, profesora nativa con más de 10 años de experiencia. 
              Aprende español de forma efectiva y diviértete.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span className="text-gray-300">Málaga, España</span>
              </li>
              <li className="flex items-start">
            ...
            <div className="mt-6 bg-blue-800 p-4 rounded-lg">
              <h4 className="font-semibold mb-2 text-blue-300">Horario</h4>
              <p className="text-sm text-gray-300">Lunes - Viernes: 9:00 - 20:00</p>
              <p className="text-sm text-gray-300">Sábado: 9:00 - 14:00</p>
            </div>
          </div>
        </div>

        <div className="border-t border-blue-800 mt-12 pt-8 text-center text-gray-400">
          <p className="mb-4">&copy; {currentYear} Spanish Classes Málaga. Todos los derechos reservados.</p>
          <p className="text-xs">Sitio web diseñado con 💙 para Virginia</p>
        </div>
      </div>
    </footer>
  );
